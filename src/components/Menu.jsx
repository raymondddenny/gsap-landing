...
function Menu() {
  ...
  useGSAP(() => {
    ...
    gsap.fromTo(
      ".details p",
      { opacity: 0, yPercent: 100 },
      { opacity: 1, duration: 1, yPercent: 0, ease: "power1.inOut", delay: 0.2 }
    );
  }, [current]);
  ...
  function getCocktailAt(indexOffset) {
    return sliderLists[
      (current + indexOffset + sliderLists.length) % sliderLists.length
    ];
  }
    ...
    <section id="menu" aria-labelledby="menu-heading">
      ...
      <div className="content">
        <div className="arrows">
          ...
          <button className="text-right" onClick={() => goToSlide(current + 1)}>
